...
class AppTextStyles {
  ...
  static final TextStyle heading70 = GoogleFonts.notoSans(
    color: AppColors.black,
    fontSize: 70,
    fontWeight: FontWeight.bold,
  );
  static final TextStyle heading40White = GoogleFonts.notoSans(
    color: AppColors.white,
    fontSize: 40,
    fontWeight: FontWeight.w600,
  );
  ...
  static final TextStyle body11White = GoogleFonts.notoSans(
    color: AppColors.white,
    fontSize: 11,
    fontWeight: FontWeight.normal,
  );

  static final TextStyle body_noAtive = GoogleFonts.notoSans(
    color: AppColors.grey,
    fontSize: 12,
    fontWeight: FontWeight.normal,
  );
